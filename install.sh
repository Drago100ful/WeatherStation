...
sudo mysql -e "
  CREATE DATABASE weather_data CHARACTER SET uft8mb4 COLLATE utf8mb4_general_ci;
  use weather_data;
  CREATE TABLE data_log(log_date DATE NOT NULL, temp INT NOT NULL, pressure  NOT NULL, altitude INT NOT NULL, humidity INT NOT NULL, PRIMARY KEY (log_date));
