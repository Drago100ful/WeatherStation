...
sudo mysql -e "
  ...
  use weather_data;
  CREATE TABLE data_log(log_date DATETIME NOT NULL, temp FLOAT NOT NULL, pressure INT NOT NULL, altitude INT NOT NULL, humidity INT NOT NULL, PRIMARY KEY (log_date));
